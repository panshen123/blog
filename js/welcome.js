...
$.ajax({
    ...
    data: {
        key: 'YYCBZ-GLJWQ-YFX5X-BRMUX-QHBLE-LGBBF',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(100.44756424547195, 38.91312599557167, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
